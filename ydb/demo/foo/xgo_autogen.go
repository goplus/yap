...
func (this *AppGen) Main() {
	_xgo_obj0 := &articles{AppGen: this}
	_xgo_obj1 := &users{AppGen: this}
	ydb.XGot_AppGen_Main(this, _xgo_obj0, _xgo_obj1)
}
...
//line ydb/demo/foo/articles_ydb.gox:69:1
	ydb.XGot_Sql_XGox_Table[Article](this, "v0.1.0")
//line ydb/demo/foo/articles_ydb.gox:70:1
	ydb.XGot_Sql_XGox_Table[Tag](this, "v0.1.0")
...
//line ydb/demo/foo/users_ydb.gox:44:1
	ydb.XGot_Sql_XGox_Table[User](this, "user v0.1.0")
