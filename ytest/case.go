...
// XGot_CaseApp_TestMain is required by XGo compiler as the entry of a YAP test case.
func XGot_CaseApp_TestMain(c interface{ initCaseApp(*App, CaseT) }, t *testing.T) {
	app := new(App).initApp()
